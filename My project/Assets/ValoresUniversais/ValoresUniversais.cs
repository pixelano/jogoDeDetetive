...
using UnityEngine;
  ...
  public class ValoresUniversais : MonoBehaviour
    ...
    public configNPC_ configNpc__;
    public static configNPC_ configNpc;

    [System.Serializable]
    public struct configNPC_ {

        [Range(0, 10)]
        public int QuantidadeMaximaDePipocas, QuantidadeMaximaDeBebidas, QuantidadeMaximaDeDoces;
    }
